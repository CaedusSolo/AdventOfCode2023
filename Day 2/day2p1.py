...
for line in dataArr:
    possible = True                  #    game id                       line
    game_id, line = line.split(":")  # [ "Game 100", "1 blue, 13 green, 14 red; 11 green, 11 blue, 7 red; 2 red, 1 blue, 2 green; 10 blue, 15 red" ]
    
    for e in line.split(";"):      #    [ "1 blue, 13 green, 14 red", "11 green, 11 blue, 7 red" , "2 red, 1 blue, 2 green", "10 blue, 15 red " ]
        for info in e.split(","):
            number, colour = info.split()   # 15 green = [15,"green"]
